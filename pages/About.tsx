...
const timelineItems = [
  {
    ...
    watermark: 'text-rose-200/60 dark:text-white/5',
  },
  {
    year: 'Insight',
    label: 'The Gap',
    ...
    watermark: 'text-amber-200/60 dark:text-white/5',
  },
  {
    year: 'Today',
    label: 'The Platform',
    ...
    watermark: 'text-emerald-200/60 dark:text-white/5',
  },
  {
    year: '→',
    label: 'The Vision',
    ...
    watermark: 'text-violet-200/60 dark:text-white/5',
  },
];
...
function TimelineCard({ item, index }: TimelineCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`relative rounded-[32px] border p-8 shadow-sm ${item.bg} ${item.border}`}
    >
      ...
      <div className={`text-[3rem] font-black select-none absolute right-6 top-4 leading-none ${item.watermark}`}>{item.year}</div>
...
function PrincipleCard({ p, i }: PrincipleCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group rounded-3xl border border-slate-200 bg-white p-7 shadow-sm hover:shadow-lg hover:shadow-emerald-100/50 hover:border-emerald-300 dark:border-slate-800 dark:bg-slate-900 dark:hover:border-emerald-700/50 dark:hover:shadow-none transition-all duration-300"
    >
...
export const About: React.FC = () => {
  ...
  return (
    <div className="overflow-x-hidden bg-white dark:bg-[#020917] text-slate-900 dark:text-white transition-colors duration-300">

      {/* ── HERO: FULL-BLEED TYPOGRAPHIC ─────────────────── */}
      <section className="relative min-h-[50vh] flex items-end overflow-hidden pb-20 pt-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-emerald-50/20 to-white dark:from-[#020917] dark:via-[#042b1e] dark:to-[#020917]">
        {/* Subtle dot grid instead of clashing watermark */}
        <div className="dot-grid absolute inset-0 opacity-20" />
        {/* Orbs */}
        <div className="ambient-orb left-[5%] top-20 h-80 w-80 bg-emerald-500/10 dark:bg-emerald-500/20" />
        <div className="ambient-orb animation-delay-2000 right-[10%] bottom-0 h-64 w-64 bg-teal-400/8 dark:bg-teal-400/15" />

        <div className="relative z-10 mx-auto max-w-7xl w-full">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <p className="text-xs font-black uppercase tracking-[0.4em] text-emerald-600 dark:text-emerald-400 mb-6">Our Story</p>
            <h1 className="text-[clamp(2.5rem,6vw,5.5rem)] font-black leading-none tracking-tight text-slate-950 dark:text-white max-w-4xl">
              We built EcoFeast because<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-500 dark:from-emerald-400 dark:to-teal-400">great food shouldn't</span><br />
              become landfill.
            </h1>
            <p className="mt-8 max-w-2xl text-lg text-slate-600 dark:text-slate-300 leading-relaxed font-medium">
      ...
      {/* ── SHOCKING STAT ─────────────────────────────────── */}
      <section ref={counterRef} className="py-20 px-4 text-center bg-white dark:bg-[#020917] transition-colors duration-300">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-4 text-slate-500 dark:text-slate-400 text-lg font-medium">
      ...
      {/* ── TIMELINE GRID ─────────────────────────────────── */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-slate-50/60 dark:bg-[#06111b] transition-colors duration-300">
      ...
      {/* ── PRINCIPLES ───────────────────────────────────── */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white dark:bg-[#020917] transition-colors duration-300">
        <div className="mx-auto max-w-7xl">
      ...
      {/* ── FOUNDER CARD ─────────────────────────────────── */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50/60 dark:bg-[#06111b] transition-colors duration-300">
        <div className="mx-auto max-w-3xl">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative overflow-hidden rounded-[40px] p-10 text-slate-900 dark:text-white border border-emerald-100 dark:border-emerald-950/20 bg-gradient-to-br from-emerald-50 via-emerald-50/30 to-teal-50/50 dark:from-[#020917] dark:via-[#064e3b] dark:to-[#059669]"
          >
            <div className="dot-grid absolute inset-0 opacity-20" />
            <div className="relative z-10">
              <p className="text-xs font-black uppercase tracking-[0.35em] text-emerald-700 dark:text-emerald-400 mb-4">Founder</p>
              <h2 className="text-4xl font-black mb-4 text-slate-950 dark:text-white">Anubhav Akhil</h2>
              <p className="text-lg text-slate-600 dark:text-slate-100 leading-relaxed max-w-xl mb-8 font-medium">
              ...
              <div className="inline-flex items-center gap-2 rounded-2xl bg-white/70 dark:bg-white/10 px-5 py-3 font-bold text-slate-700 dark:text-white backdrop-blur border border-emerald-200 dark:border-white/15 shadow-sm">
      ...
      {/* ── CTA ──────────────────────────────────────────── */}
      <section className="py-20 px-4 text-center bg-white dark:bg-[#020917] transition-colors duration-300">
        <h2 className="text-4xl font-black text-slate-950 dark:text-white mb-6">Ready to help rescue food?</h2>
        <div className="flex gap-4 justify-center flex-wrap">
          <Link to="/marketplace" className="inline-flex items-center gap-2 rounded-2xl bg-emerald-600 px-8 py-4 font-bold text-white shadow-lg shadow-emerald-200/50 dark:shadow-none transition hover:bg-emerald-500 hover:-translate-y-1">
